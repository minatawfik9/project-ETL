...
### *Data Sources*  
> The project uses cleaned and structured datasets related to transactions, customers, and inventory.

**📑 Example Tables:**  
1. **Sales Table**  
   - Order ID, Date, Product, Region, Quantity, Unit Price, Total Revenue  

2. **Customer Table**  
   - Customer ID, Name, Segment, Country  

3. **Product Table**  
   - Product ID, Name, Category, Cost, Profit Margin  
